...
const PackageCard = ({ Package, deletePackage }) => {
  ...
  return (
    <>
      <div className="grid grid-cols-1 min-w-60 max-w-96 h-[450px] p-5 bg-[#006d77] my-3 shadow-lg rounded-lg text-white transition-transform ease-in duration-200 transform hover:scale-105 overflow-auto ">
        ...
        <div className="mb-5 p-2 min-h-40 overflow-y-auto">
